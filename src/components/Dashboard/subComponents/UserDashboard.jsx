    ...
    <div className="ml-2 mr-10">
      ...
      <div className="w-full px-9">
        <div className="flex flex-col lg:flex-row items-center mb-4 mt-6 max-w-7xl gap-x-6 ml-10 w-[90%]">
          ...
          {/* Auto Apply Button */}
          <button className="flex items-center justify-center h-input py-6 px-1 rounded-3xl border-2 border-pale-purple mt-6 lg:mt-0 lg:-mb-5 ml-0 lg:ml-10">
          ...
          {/* Daily Limit */}
          <p className="text-light-purple text-xs font-thin mt-6 xl:ml-60 mlg:ml-20">

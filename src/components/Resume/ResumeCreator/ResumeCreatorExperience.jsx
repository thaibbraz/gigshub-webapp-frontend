                    ...
                    <Select
                      ...
                      value={
                        unsavedExp.date.split("-")[field.index]
                          ? {
                              value: unsavedExp.date.split("-")[field.index],
                              label: unsavedExp.date.split("-")[field.index],
                            }
                          : null
                      }

  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="flex items-center justify-between gap-x-1.5 bg-white hover:bg-gray-50 border border-gray-300 rounded-2xl h-input py-3 px-4 w-full shadow dark-blue text-gray-400 text-sm"
        id="menu-button"
